...
class ICameraDevicePtr(_object):
    ...
    def getExposureMode(self, exposureMode, streamId=0):
        return _roypy.ICameraDevicePtr_getExposureMode(self, exposureMode, streamId)
...
class ICameraDevice(_object):
    ...
    def getExposureMode(self, exposureMode, streamId=0):
        return _roypy.ICameraDevice_getExposureMode(self, exposureMode, streamId)
